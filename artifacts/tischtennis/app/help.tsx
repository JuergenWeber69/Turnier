...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { label: 'Wechselnde Partner', detail: 'Jede Runde werden neue Doppelpaare gebildet — jeder Spieler bekommt möglichst oft einen anderen Partner.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: 'Nächste Runde starten', detail: 'Erst nach dem Antippen dieses Buttons werden die nächsten Paarungen generiert.' },
